...
class="fixed top-4 left-1/2 transform -translate-x-1/2 z-50 w-full max-w-sm px-4 sm:left-auto sm:right-4 sm:transform-none sm:-translate-x-0">
    <div x-show="show"
        :class="{
        ...
        class="rounded-lg border px-4 py-2 text-sm shadow-lg sm:px-6 sm:py-3">
